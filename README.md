...
A recurse added in Grr Language that don't belong a gramatic of chomsky it's a parameterization of rules it's means that rules can be ignore and extract substring and treat this.
